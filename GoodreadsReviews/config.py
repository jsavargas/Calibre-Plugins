...
#         c = plugin_prefs[STORE_NAME]
        ...
        self.get_asin_checkbox = QCheckBox('Get ASIN for kindle editions', self)
        self.get_asin_checkbox.setToolTip('When this option is checked, in cases where Goodreads has an ASIN listed\n'
